...
@Autonomous(name = "AUTON//blue pos(x) ⸙", group = "Linear Op-mode")
public class AUTN_bPX extends LinearOpMode {
    ...
    private final Pose shootPose = new Pose(57.4,16.3,Math.toRadians(113));
