...
public class AUTN_rNX extends LinearOpMode {
    ...
    private final Pose leave = new Pose(96, 120, Math.toRadians(25));
    ...
    public void runOpMode() {
        ...
        telemetry.addData("03/", "Selected Performance - 🔴Red Outlying");
        telemetry.update();
        //||||||||||||||||||||||||||||||||||||||//
        //-----------------------------------------------PREP
