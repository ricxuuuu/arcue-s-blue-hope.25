...
@Autonomous(name = "AUTON//blue pos(x) playAROUND", group = "Linear Op-mode")
public class AUTN_bPX_pA extends LinearOpMode {
    ...
    private final Pose approachHpPose = new Pose(9,27,Math.toRadians(270));
    private final Pose pickupHpPose = new Pose(9,12,Math.toRadians(270));
    ...
    private final Pose pickupRepeatPose = new Pose(10, 13, Math.toRadians(0));
    ...
    public void runOpMode() {
        ...
        telemetry.addData("03/", "Selected Performance - 🔵Blue Audience playAROUND");
        telemetry.update();
        //||||||||||||||||||||||||||||||||||||||//
        //-----------------------------------------------PREP
        ...
        while (opModeIsActive()) {
            ...
            //-----------------------------------------------TELEMETRY
            telemetry.addData("---------------------//STATUS-BLUE-playAROUND", "hunting...");
